...
namespace xUnitWithAutoFixture.Api.UnitTests.Providers
{
    ...
    {
        [Theory, AutoMockData]
        public void GetAcceptedLocales_When_Test(
            [Frozen] IHttpContextAccessor httpContextAccessor,
            AcceptLanguageProvider sut)
        {
            // arrange
            var defaultHttpContext = new DefaultHttpContext();
            defaultHttpContext.Request.Headers["Accept-Language"] = "en-NZ,en;q=0.9,zh-CN;q=0.8,zh;q=0.7,en-GB;q=0.6,en-US;q=0.5";
